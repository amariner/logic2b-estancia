...
Continuar el segundo bloque de **P5 · Conectividad demostrable y madurez real** definiendo el contrato de preparación de pagos sin crear una capacidad ejecutable. Debe centralizar propietario y alcance comercial, permisos, categoría de proveedor sin marca, referencia de configuración sin valores, entorno de prueba, monedas e importes, autorización/captura/devolución, idempotencia, webhooks y conciliación, fallos y reintentos, auditoría sin datos de pago, aceptación, kill switch y reversión. La superficie de conectividad podrá mostrar el expediente ES/EN como `pendiente` y con cero condiciones validadas, pero no añadirá checkout, tarjeta, sesión, cobro, devolución, proveedor, cuenta, secreto, endpoint, webhook real, persistencia o escritura. Cualquier activación requerirá autorización y validación separadas.
