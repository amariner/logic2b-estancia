...
Continuar el segundo bloque de **P5 · Conectividad demostrable y madurez real** definiendo el contrato de preparación de datos/PMS y fuente de verdad sin crear una integración ejecutable. Debe centralizar responsable y sistema fuente, finalidad/minimización, permisos, categoría de proveedor sin marca, referencia de configuración sin valores, entidades y campos, identificadores/matching, baseline o migración, casos aislados, idempotencia, reconciliación, fallos/recuperación, auditoría sin PII, aceptación, kill switch y reversión. La franja de conectividad podrá mostrar el expediente ES/EN como `pendiente` y 0/16, manteniendo los expedientes cerrados por defecto; no añadirá marca, cuenta, credencial, PMS, API, webhook, huésped real, registro de viajeros, migración, persistencia, sincronización o escritura externa. Cualquier activación requerirá autorización y validación separadas.
