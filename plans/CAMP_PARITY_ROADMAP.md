...
> **Documento histórico desde el 2026-09-14.** La nueva cola estratégica solicitada por el usuario está en [HOSPITALITY_PARITY_ROADMAP.md](./HOSPITALITY_PARITY_ROADMAP.md), con investigación de SuperHote, Cloudbeds y Mews. Este documento conserva decisiones y pruebas de su fecha; no reabre trabajo completado ni certifica el árbol local actual. Las prohibiciones históricas de precios quedaron sustituidas por la autorización del 2026-09-05 en `AGENTS.md`; los importes y condiciones vigentes están en `apps/site/src/pricing.ts`. Los límites y referencias visuales de conexiones y las rutas de temas se deben reconciliar mediante R0 del nuevo roadmap. Ante discrepancia prevalece el checkpoint actual.
