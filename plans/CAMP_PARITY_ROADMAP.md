...
Estado de ejecución: P0, P1, P2, P3 y P4 cerrados; 12/12 direcciones web, 6/6 fichas de panel y 5/5 guías por rol navegables y enlazadas contextualmente. P5 está en curso con el primer bloque visual 3/3 y cinco contratos de preparación cerrados; P6 permanece pendiente.
...
Cerrar el segundo bloque de **P5 · Conectividad demostrable y madurez real** con un registro canónico de preparación y una puerta de validación de proveedores. Debe reunir los cinco contratos existentes sin duplicar su copy, demostrar que hoy existen cero proveedores validados y cero activaciones, y exigir evidencia de contrato, responsable, permisos, configuración opaca, pruebas aisladas, fallos, auditoría, aceptación, kill switch y reversión antes de permitir marca o estado `activo`. No se añadirá proveedor, logo, cuenta, credencial, endpoint, API, webhook, persistencia o escritura; la validación real de cualquier proveedor seguirá bloqueada hasta una decisión y autorización específicas.
