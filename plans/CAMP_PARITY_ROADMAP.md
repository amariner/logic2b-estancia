...
Continuar **P6 · Medición y optimización** con el último incremento local seguro antes de la activación: generar un expediente offline y validable de GTM a partir del contrato `2.3.0`. Debe enumerar etiquetas, activadores y parámetros exactos de Estancias, aislar su namespace del comportamiento de Camp dentro del contenedor compartido, documentar consentimiento, verificación, rollback y fecha de corte de la línea base, y fallar si contrato y expediente divergen. No debe conectarse a GTM, modificar el contenedor, activar el runtime, desplegar ni fabricar datos. Aplicar el expediente, recoger el primer periodo agregado y elegir un experimento requieren autorización y actividad humana externas. La validación de proveedores de P5 sigue bloqueada por decisión, contrato, credenciales y evidencias específicas.
