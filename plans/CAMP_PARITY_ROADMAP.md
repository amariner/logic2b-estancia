...
Continuar el segundo bloque de **P5 · Conectividad demostrable y madurez real** definiendo el contrato de preparación de publicación web supervisada para Terrava. Debe centralizar propietario, permisos, referencia de repositorio y entorno sin URL ni secreto, rama o versión, preview aislada, validación de contenido, casos de fallo, auditoría, criterios de aceptación, ventana de cambio, kill switch y reversión. `?vista=website` podrá mostrar ese expediente ES/EN manteniendo la edición, borrador y aprobación exclusivamente locales; aprobar no equivale a publicar. No se añadirán CMS, repositorio, cuenta, token, despliegue, dominio, webhook, proveedor activo o escritura externa. Una publicación real solo podrá mostrarse después de autorización, entorno aislado, pruebas y reversión verificadas.
