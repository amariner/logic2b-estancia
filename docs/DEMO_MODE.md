...
| Editor web supervisado | `demo_visual_disponible` | Edición, borrador, descarte y aprobación humana local en Terrava | Solo Dirección aprueba; no hay CMS, repositorio, despliegue, proveedor o escritura HTTP y recargar restaura el fixture |
