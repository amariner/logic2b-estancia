...
| Email y mensajería de producto | Nivora representa tres solicitudes ficticias, su vista previa local y un expediente de trece condiciones | Email, SMS o mensajería externa | Sin campos personales, destinatarios reales, envío o proveedor; la interacción vive en memoria y conserva 0/13 condiciones validadas | Validar responsable, base jurídica/finalidad, permisos, categoría de proveedor, referencia opaca, plantillas, enrutado, idempotencia, fallos, auditoría, aceptación, kill switch y reversión |
| Publicación web | Terrava permite editar, descartar y aprobar localmente un titular ficticio y revisar un expediente de doce condiciones | Escritura en CMS o despliegue | Estado solo en memoria, aprobación limitada a Dirección y 0/12 condiciones validadas; sin CMS, repositorio, proveedor o HTTP | Validar propietario, permisos, referencia opaca de repositorio/entorno, versión, preview aislada, contenido, fallos, auditoría, aceptación, ventana, kill switch y reversión |
| Canales | Cuatro categorías genéricas con cero conexiones y un expediente de doce condiciones por categoría | Inventario, tarifas, reservas o mensajes | Sin marca validada, cuenta, credencial, OAuth, webhook o adaptador; proveedor `disabled` | Validar propietario, permisos, referencia de secretos, mapeo, sandbox, idempotencia, reconciliación, fallos, auditoría, aceptación, kill switch y reversión |
...
| Canales e inventario | `activable_por_proyecto` | Matriz y expediente de preparación con doce condiciones documentadas por categoría | Cero canales conectados y cero expedientes validados; no se muestra una marca hasta validar proveedor y contrato |
