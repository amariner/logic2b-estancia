...
const spanish: Omit<HomeContract, 'locale'> = {
  ...
  productAreas: [
    { id: 'web', number: '01', title: 'Web', text: 'Diseño, contenido y fundamentos SEO para que la estancia se entienda antes de comparar por precio.', plan: 'Básico', boundary: 'Sin dashboard, inventario, reserva ni cobro real.', href: '/demos/nivora/#espacio', cta: 'Explorar la web de Nivora' },
    ...
    { id: 'huespedes', number: '04', title: 'Huéspedes', text: 'El equipo consulta la información de la estancia sin repetirla entre conversaciones y hojas.', plan: 'Gestión', boundary: 'Datos de ejemplo; no crea perfiles ni registros de viajeros.', href: '/demos/terrava/gestion/?vista=guests', cta: 'Ver huéspedes en Terrava' },
  ...
  capabilityGroups: [
    ...
    { id: 'conexiones', number: '04', title: 'Conexiones supervisadas', text: 'Canales, pagos, datos y automatización se validan por proyecto, no por asociación visual.', capabilityIds: ['channels', 'automation', 'supervised-ai'] },
  ],
  capabilityStatusCopy: {
...
const english: Omit<HomeContract, 'locale'> = {
  ...
  productAreas: [
    { id: 'web', number: '01', title: 'Website', text: 'Design, content and SEO foundations so the stay is understood before it is compared on price.', plan: 'Basic', boundary: 'No workspace, inventory, booking or live payment.', href: '/en/demos/nivora/#espacio', cta: 'Explore the Nivora website' },
    ...
    { id: 'huespedes', number: '04', title: 'Guests', text: 'The team can consult stay information without repeating it across conversations and sheets.', plan: 'Management', boundary: 'Sample data; no guest profiles or traveller records are created.', href: '/en/demos/terrava/gestion/?vista=guests', cta: 'See guests in Terrava' },
  ...
  capabilityGroups: [
    ...
    { id: 'conexiones', number: '04', title: 'Supervised connections', text: 'Channels, payments, data and automation are validated per project, not implied by a visual.', capabilityIds: ['channels', 'automation', 'supervised-ai'] },
  ],
  capabilityStatusCopy: {
    eyebrow: 'Capabilities in view',
    title: 'Connect what already works. Add what the project can sustain.',
    body: 'Every group keeps its status, evidence and boundary. The demo helps you decide; it activates no provider, booking, payment, message, synchronisation or automation.',
    evidence: 'Evidence',
    boundary: 'Boundary',
  },
};
