...
const spanish: Omit<HomeContract, 'locale'> = {
  ...
  capabilityGroups: [
    ...
    { id: 'conexiones', number: '04', title: 'Conexiones supervisadas', text: 'Canales, pagos y automatización se validan por proyecto, no por asociación visual.', capabilityIds: ['channels', 'automation', 'supervised-ai'] },
  ],
  capabilityStatusCopy: {
    eyebrow: 'Capacidades a la vista',
    title: 'Conecta lo que ya funciona. Añade lo que el proyecto pueda sostener.',
    body: 'Cada grupo conserva su estado, evidencia y límite. La demo ayuda a decidir; no activa proveedores, reservas, pagos, mensajes ni automatizaciones.',
    evidence: 'Evidencia',
    boundary: 'Límite',
  },
};
...
const english: Omit<HomeContract, 'locale'> = {
  ...
  capabilityGroups: [
    ...
    { id: 'conexiones', number: '04', title: 'Supervised connections', text: 'Channels, payments and automation are validated per project, not implied by a visual.', capabilityIds: ['channels', 'automation', 'supervised-ai'] },
  ],
  capabilityStatusCopy: {
    eyebrow: 'Capabilities in view',
    title: 'Connect what already works. Add what the project can sustain.',
    body: 'Every group keeps its status, evidence and boundary. The demo helps you decide; it activates no provider, booking, payment, message or automation.',
    evidence: 'Evidence',
    boundary: 'Boundary',
  },
};
