    ...
    copy: {
      es: {
        ...
        boundaries: [
          ...
          'El expediente de datos/PMS de la portada conserva 0/16 condiciones validadas: no contiene cuenta, credencial, conexión PMS, API, webhook o datos reales y no migra, persiste, sincroniza ni escribe fuera.',
          'El registro de preparación reúne cinco expedientes, cero proveedores validados y cero activaciones. La puerta común exige diez evidencias completas antes de considerar una marca y aun así requiere autorización separada.',
      ...
      en: {
        ...
        boundaries: [
          ...
          'The data/PMS file on the home page retains 0/16 validated conditions: it holds no account, credential, PMS connection, API, webhook or live data and performs no migration, persistence, synchronisation or external write.',
          'The readiness registry brings together five files, zero validated providers and zero activations. The shared gate requires ten complete pieces of evidence before a brand can be considered and still needs separate authorisation.',
